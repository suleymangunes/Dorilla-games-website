...
class ClickableLinkedinCard extends StatelessWidget {
  const ClickableLinkedinCard({super.key});

  @override
  Widget build(BuildContext context) {
    return ClickableUrlCard(
      picture: SvgEnum.linkedin.getSvg,
      platform: ProjectKeys.linkedin,
      function: () {
        UrlLauncherSingleton.launch(UrlEnum.linkedin.getUrl);
      },
    );
  }
}
