...
class ClickableGithubCard extends StatelessWidget {
  const ClickableGithubCard({super.key});

  @override
  Widget build(BuildContext context) {
    return ClickableUrlCard(
      picture: SvgEnum.github.getSvg,
      platform: ProjectKeys.github,
      function: () {
        UrlLauncherSingleton.launch(UrlEnum.github.getUrl);
      },
    );
  }
}
